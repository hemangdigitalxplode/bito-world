        ...
        <>
            <div style={{ backgroundColor: '#f5e0cb' }}>
                <Container style={{ padding: '40px 0' }}>
                    ...
                    <Row style={{padding:'50px 0'}}> 
                        <Col style={{width:'31%'}} lg={3}>
                            <div className='address-div'>
                                ...
                                <span>Address:</span>
                                <p className='address-para'>173, 7th Floor, Tower A, Corenthum, Sector 62, Opp. Electronic City Metro Station, Noida-201309
                                    Phone: 0120-4914498</p>

                                <p className='email'> <span>Email:</span>office@bitoworld.in</p>
                            </div>
                        </Col>
                        ...
                        <Col className='mx-auto' style={{width:'44%'}} lg={3}>
                            <div className='newsletter-div'>
                                <p>Newsletter</p>
                                <div style={{gap:'6px'}} className='news-email-contact d-flex align-items-center'>
                                ...
                                <div className='social-footer'>
                                  ...
                                  <div className='social-icons d-flex align-items-center'>
                                    <Link><Image src={Facebook} className='social-links-img' alt='footer-social-logo'/></Link>
                                    <Link><Image src={Instagram} className='social-links-img' alt='footer-social-logo'/></Link>
                                    <Link><Image src={Linkedin} className='social-links-img' alt='footer-social-logo'/></Link>
                                    <Link><Image src={Twitter} className='social-links-img' alt='footer-social-logo'/></Link>
                                    <Link><Image src={Youtube} className='social-links-img' alt='footer-social-logo'/></Link>
                                  </div>
                                </div>
                            </div>
                        </Col>
                    ...
                    <Container>
                        <Col lg={12}>
                        <p className='footer-last-line text-center'>Copyright © 2023 Bihar International Trade Organization (BITO)</p>
                        </Col>
                    </Container>
