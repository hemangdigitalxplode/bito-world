...
const Roadmap = () => {
    return (
        <>
            <div style={{ backgroundColor: '#fffbf5', position: 'relative' }}>
                <Container>
                    <h1 style={{ color: '#b27f4a', fontWeight: '700' }} className='text-center'>5 YEARS ROAD MAP</h1>

                    {/* First section */}
                    <Row style={{marginTop:'40px'}}>
                        <Col lg={5}>
                            <div className='1-2yr-div'>
                                <span style={{ fontWeight: '700', fontSize: '23px' }}>Years 1-2  |  <span style={{ fontWeight: 'bold', color: '#9c7041' }}>Foundation & Growth</span></span>
                    ...
                    <Row style={{ marginTop: '25px' }}>
                        ...
                        <Col lg={5}>
                            <div className='3-4yr-div'>
                                <span style={{ fontWeight: '700', fontSize: '23px' }}>Years 3-4  |  <span style={{ fontWeight: 'bold', color: '#9c7041' }}>Acceleration</span></span>
                                <div style={{ marginTop: '30px' }}>
                    ...
                    <Row style={{ marginTop: '25px' }}>
                        <Col lg={5}>
                            <div className='5yr-div'>
                                <span style={{ fontWeight: '700', fontSize: '23px' }}>Year 5  |  <span style={{ fontWeight: 'bold', color: '#9c7041' }}>Consolidation & Expansion</span></span>
                                <div style={{ marginTop: '30px' }}>
